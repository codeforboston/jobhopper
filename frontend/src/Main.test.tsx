...
import { findByTestId, findByText, findByTitle, fireEvent, getAllByRole, getAllByTestId, getByLabelText, getByRole, getByTestId, getByText, getQueriesForElement, prettyDOM, queryByRole, queryByText, within } from '@testing-library/dom';
...
import { getClasses, createMount, createRender} from '@material-ui/core/test-utils';
...
describe('transitions results page', () => {
  ...
  test('Can select option in OccupationSelect Select', async() => {
    ...
    await waitFor(()=>expect(getByText(/Job Transitions/i)).toBeInTheDocument());
